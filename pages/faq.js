...
const faq = () => {
  return (
    <>
      <NextSeo
        title="Frequently Asked Questions - Ephemere cloud"
        description="This page describe the frequently asked questions by our users"
      />
      <MainWrapper>
          ...
          <article>
            <div className="my-8">
              ...
              <article className="text-gray-500">
                Upload a file, set a password to protected it, set a timer for
                the file before it got removed, click on upload and share the
